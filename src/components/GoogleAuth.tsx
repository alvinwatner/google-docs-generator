...
// Define types for Google Auth responses and user data
interface GoogleUser {
  ...
  token?: string;
  accessToken?: string;
  [key: string]: unknown; // For any additional properties from Google API
}
...
export default function GoogleAuth({ onAuthenticated }: GoogleAuthProps) {
  ...
  const handleGoogleSignIn = () => {
    ...
    const tokenClient = window.google?.accounts.oauth2.initTokenClient({
      client_id: process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID,
      scope:
        "https://www.googleapis.com/auth/documents https://www.googleapis.com/auth/drive.file https://www.googleapis.com/auth/drive.readonly https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email",
    ...
    <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg p-8">
      <div className="text-center">
        ...
        <p className="text-gray-600 mb-8">
          Sign in with your Google account to access Google Docs and Drive for
